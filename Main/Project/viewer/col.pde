...
color red, yellow, green, cyan, blue, magenta, dred, dyellow, dgreen, dcyan, dblue, dmagenta, ddmagenta, white, black, orange, grey, grey2, metal, dorange, brown, dbrown;
void setColors() {
   red = color(250,0,0);        dred = color(150,0,0);
   magenta = color(250,0,250);  dmagenta = color(150,0,150);  ddmagenta = color(90,0,90); 
